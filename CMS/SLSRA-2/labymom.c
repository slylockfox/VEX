...
task main()
{
	...
	while(SensorValue[leftEncoder] < 1260)  // While less than 5 rotations on the leftEncoder...
	{
		//...Move Forward
		motor[rightMotor] = 63;
		motor[leftMotor] = 63;
	...
	while(SensorValue[rightEncoder] < 720)  // While less than 5 rotations on the leftEncoder...
	{
		//...Move Forward
		motor[rightMotor] = 63;
		motor[leftMotor] = -63;
