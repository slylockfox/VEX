...
task main()
{
	...
	wait1Msec(1250);			        // Robot runs previous code for 3000 milliseconds before moving on
	motor[rightMotor] = -127;		  // Motor on port2 is run at full (127) power forward
	motor[leftMotor]  = -127;		  // Motor on port3 is run at full (127) power forward
	wait1Msec(1250);
	motor[rightMotor] = 127;		  // Motor on port2 is run at full (127) power forward
	motor[leftMotor]  = 127;		  // Motor on port3 is run at full (127) power forward
	wait1Msec(3300);			        // Robot runs previous code for 3000 milliseconds before moving on
	motor[rightMotor] = -127;		  // Motor on port2 is run at full (127) power forward
	motor[leftMotor]  = -127;		  // Motor on port3 is run at full (127) power forward
	wait1Msec(3300);
		motor[rightMotor] = 127;		  // Motor on port2 is run at full (127) power forward
	motor[leftMotor]  = 127;		  // Motor on port3 is run at full (127) power forward
	wait1Msec(7500);			        // Robot runs previous code for 3000 milliseconds before moving on
